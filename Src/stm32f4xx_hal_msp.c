...
void HAL_ETH_MspDeInit(ETH_HandleTypeDef* heth)
{
  if(heth->Instance==ETH)
  {
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOC, MII_TX_CLK_Pin|MII_MDC_Pin|MII_TXD2_Pin|MII_RXD0_Pin
                          |MII_RXD1_Pin);

    HAL_GPIO_DeInit(GPIOA, MII_RX_CLK_Pin|MII_MDIO_Pin|MII_RX_DV_Pin);
...
void HAL_HCD_MspDeInit(HCD_HandleTypeDef* hhcd)
{
  if(hhcd->Instance==USB_OTG_FS)
  {
    ...
    PA11     ------> USB_OTG_FS_DM
    */
    HAL_GPIO_DeInit(GPIOA, USB_FS1_DP_Pin|USB_FS1_DM_Pin);
...
static void HAL_FMC_MspInit(void){
  ...
  */
  ...
  GPIO_InitStruct.Pin = D23_Pin|D21_Pin|D22_Pin|SDNWE_Pin
                          |FMC_SDNE0_Pin|SDCKE0_Pin|D20_Pin|D17_Pin
...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOD, FMC_NE1_Pin|FMC_NWAIT_Pin|D2_Pin|FMC_NWE_Pin
                          |D3_Pin|FMC_NOE_Pin|D1_Pin|D15_Pin
                          |D0_Pin|D14_Pin|D13_Pin|A17_Pin
                          |A18_Pin|A16_Pin);
  ...
  HAL_GPIO_DeInit(GPIOG, SDNCAS_Pin|FMC_NE2_Pin|SDCLK_Pin|A11_Pin
                          |A13_Pin|A12_Pin|A10_Pin|A15_Pin
                          |A14_Pin);
